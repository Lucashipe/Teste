...
uses
  ...
  uDm_Conn,
  Vcl.Buttons, uDm_Login, U_IndexMedico, Vcl.ComCtrls, uDm_Query;
...
begin
  ...
  begin
    ...
    begin
      Lb_Error.Left := 100;
      Lb_Error.Caption := 'Usuário ou senha incorretos!';
  ...
  begin
    ...
    Lb_Error.Caption := 'Digite o usuário e senha corretamentes!';
  end;
