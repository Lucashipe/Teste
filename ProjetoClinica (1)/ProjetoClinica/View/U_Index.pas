...
type
  ...
  TFormIndex = class(TForm)
    ...
    procedure pnl_LogoutMouseEnter(Sender: TObject);
    procedure pnl_LogoutMouseLeave(Sender: TObject);
...
begin
  ...
  DrawControl(Panel8);
  pnl_Logout.BorderStyle := bsNone;
  DrawControl(pnl_Logout);
...
procedure TFormIndex.pnl_LogoutClick(Sender: TObject);
begin
  CloseAllForms;
...
procedure TFormIndex.pnl_LogoutMouseEnter(Sender: TObject);
begin
  Panel15.Color := $00777724;
end;

procedure TFormIndex.pnl_LogoutMouseLeave(Sender: TObject);
begin
  Panel15.Color := clGray;
end;
